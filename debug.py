...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='BERNOULLIFAN', id=1, devices={'master': DeviceState(values=OrderedDict([('tableAngle', 'uint16_t'), ('fanAngle', 'uint16_t')]), events=['demo', 'homeFan', 'liftBall']), 'amib2': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values=OrderedDict([('tableAngle', 'uint16_t'), ('fanAngle', 'uint16_t')]), events=['demo', 'homeFan', 'liftBall'])}), State(name='FISHYTANK', id=2, devices={'master': DeviceState(values=OrderedDict([('fishyMotorSpeed', 'uint16_t')]), events=['spinTank']), 'amib2': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='MAGNETICVORTEX', id=3, devices={'master': DeviceState(values=OrderedDict([('motorSpeed', 'uint16_t'), ('motorDir', 'uint16_t'), ('DCMotorSpeed', 'uint16_t'), ('dialPosition', 'uint8_t')]), events=['pistonStop', 'demo', 'cycleBall', 'startSensor', 'lowPiston', 'highPiston']), 'amib2': DeviceState(values=OrderedDict(), events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values=OrderedDict(), events=['pistonStop', 'cycleBall', 'startSensor', 'lowPiston', 'highPiston'])}), State(name='SPINNYLIFTER', id=4, devices={'master': DeviceState(values=OrderedDict([('spinnyOffset1', 'int16_t'), ('topSensor', 'uint16_t')]), events=['demo', 'cycleBall', 'liftBall']), 'amib2': DeviceState(values=OrderedDict([('topSensor', 'uint16_t')]), events=['liftBall']), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='SPINNYLIFTER2', id=5, devices={'master': DeviceState(values=OrderedDict([('spinnyOffset1', 'uint16_t')]), events=['demo', 'cycleBall', 'cycleEntranceStop', 'cycleExitStop', 'stopMovement']), 'amib2': DeviceState(values=OrderedDict(), events=['cycleEntranceStop']), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values=OrderedDict([('spinnyOffset1', 'uint16_t')]), events=['demo', 'cycleBall', 'cycleExitStop', 'stopMovement'])}), State(name='SPINNYPASSIVEDROP', id=6, devices={'master': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='SWISHYBOATS', id=7, devices={'master': DeviceState(values=OrderedDict([('LIDAR1Trig', 'bool'), ('LIDAR2Trig', 'bool'), ('LIDAR3Trig', 'bool'), ('LIDAR4Trig', 'bool'), ('boatNumber', 'uint16_t')]), events=['cycleEntranceStop', 'cycleExitStop', 'cycleBall', 'lastBoat', 'entranceStopOn', 'entranceStopOff', 'test']), 'amib2': DeviceState(values=OrderedDict([('LIDAR1Trig', 'bool'), ('LIDAR2Trig', 'bool'), ('LIDAR3Trig', 'bool'), ('LIDAR4Trig', 'bool')]), events=['cycleEntranceStop', 'cycleExitStop', 'cycleBall', 'lastBoat', 'entranceStopOn', 'entranceStopOff', 'test']), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])}), State(name='BALLCHECK', id=8, devices={'master': DeviceState(values=OrderedDict([('ballSense1', 'bool'), ('ballSense2', 'bool'), ('ballSense3', 'bool'), ('ballSense4', 'bool')]), events=['checkSensors', 'waitForBall', 'amib2Ready', 'amib3Ready', 'amib2NotReady', 'amib3NotReady']), 'amib2': DeviceState(values=OrderedDict([('ballSense1', 'bool'), ('ballSense2', 'bool'), ('ballSense3', 'bool'), ('ballSense4', 'bool')]), events=['checkSensors']), 'tablet': DeviceState(values=OrderedDict([('ballSense1', 'bool'), ('ballSense2', 'bool'), ('ballSense3', 'bool'), ('ballSense4', 'bool')]), events=['resume', 'amib1Ready', 'amib2Ready', 'amib3Ready', 'amib1NotReady', 'amib2NotReady', 'amib3NotReady', 'checkBallDone']), 'amib3': DeviceState(values=OrderedDict([('ballSense1', 'bool'), ('ballSense2', 'bool'), ('ballSense3', 'bool'), ('ballSense4', 'bool')]), events=['checkSensors'])}), State(name='OFF', id=9, devices={'master': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib3': DeviceState(values={}, events=[])})]
